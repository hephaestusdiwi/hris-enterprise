...
const groups: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'thr-policies', label: 'THR Policy', icon: Gift, to: '/thr-policies', permission: 'view thr payroll' },
      { name: 'non-regular-payroll-components', label: 'Non-Regular Components', icon: Layers, to: '/non-regular-payroll-components', permission: 'view non regular payroll' },
      { name: 'employee-non-regular-inputs', label: 'Non-Regular Input', icon: HandCoins, to: '/employee-non-regular-inputs', permission: 'view non regular payroll' },
  ...
  },
  {
    ...
    icon: ClipboardList,
    items: [
      { name: 'grooming-self', label: 'Grooming Self', icon: ClipboardList, to: '/grooming-self', permission: null },
      { name: 'grooming-store', label: 'Grooming Store', icon: ClipboardList, to: '/grooming-store', permission: 'submit grooming store' },
      { name: 'grooming-self-monitoring', label: 'Monitoring Self', icon: ClipboardList, to: '/grooming-self/monitoring', permission: 'view grooming self' },
      { name: 'grooming-store-monitoring', label: 'Monitoring Store', icon: ClipboardList, to: '/grooming-store/monitoring', permission: 'view grooming store' },
      { name: 'grooming-standards', label: 'Grooming Standards', icon: ClipboardList, to: '/grooming-standards', permission: 'manage grooming standards' },
    ],
  },
  {
    name: 'administration',
