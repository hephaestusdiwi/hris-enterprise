...
class GroomingSelfSubmissionAnswer extends Model
{
    protected $fillable = [
        'grooming_self_submission_id',
    ...
    {
        return $this->belongsTo(GroomingSelfSubmission::class, 'grooming_self_submission_id');
    }
